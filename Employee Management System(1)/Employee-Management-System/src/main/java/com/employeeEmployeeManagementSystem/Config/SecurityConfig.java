...
public class    SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/organisations/**").hasAnyAuthority("Admin","Manager","Employee")
                .antMatchers(HttpMethod.PUT, "/api/organisations/**").hasAnyAuthority("Admin","Manager")
